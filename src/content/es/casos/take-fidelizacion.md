**Caso de estudio · Aplicaciones móviles y fidelización**
...
<div class="case-metric-grid">
  <div class="case-metric-card case-metric-card-featured"><strong>37.627</strong><span>visitas selladas con QR</span><small>métrica de producción</small></div>
  <div class="case-metric-card"><strong>2.921</strong><span>usuarios registrados</span><small>resultado medido</small></div>
  <div class="case-metric-card"><strong>90,3 %</strong><span>repetición entre clientes sellados</span><small>resultado medido</small></div>
</div>

## El proyecto partió de un proceso real, no de una demo aislada

Una cafetería de Santiago usa una app con tarjeta en Wallet, sellos QR, recompensas y juegos para medir la repetición de sus clientes. El objetivo era llevar la automatización al punto donde el equipo ya trabajaba y medir qué ocurría después de ponerla en producción.

## La solución se adaptó al sistema que ya tenía el cliente
...
En producción desde el 28 de agosto de 2025. 2.119 recompensas entregadas.
...
La repetición describe a los usuarios que sellaron. No se presenta como atribución causal sobre las ventas.
...
- **Categoría:** Aplicaciones móviles y fidelización.
- **Estado:** En producción desde el 28 de agosto de 2025. 2.119 recompensas entregadas.
