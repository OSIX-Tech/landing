...
**Veredicto:** IA360 es la referencia gallega cuando el proyecto tiene un componente claro de inteligencia artificial y está vinculado al tejido industrial y a los sectores estratégicos definidos por la Xunta. En la ficha oficial consultada, la convocatoria 2026/2027 figura como cerrada, con plazo del 17 de enero al 17 de marzo de 2026.

**Mejor para:** empresas que preparen con tiempo un proyecto de desarrollo experimental o implantación de IA para una próxima convocatoria. La ficha contempla dos líneas:

- Línea A: desarrollo de productos o servicios basados en IA para mejorar procesos industriales o comercializar nuevos productos.
- Línea B: adquisición e implantación de soluciones basadas en IA para mejorar la productividad empresarial.

Para ambas líneas pueden ser beneficiarias las pymes gallegas o con un centro de trabajo permanente y legalmente constituido en Galicia. En la línea A también pueden entrar grandes empresas. El proyecto debe desarrollarse en Galicia y la actividad debe estar vinculada al tejido industrial, la cadena de valor y los sectores estratégicos o de especial interés que defina la Xunta.

**Límite:** no es una ayuda abierta que puedas solicitar hoy según la ficha consultada. Además, el proyecto no debe haberse iniciado ni existir un acuerdo irrevocable para realizarlo en el momento de la solicitud. Si la próxima convocatoria mantiene esta lógica, conviene preparar antes el caso de uso, el presupuesto, los indicadores y la memoria.

Fuente oficial: [Ficha del procedimiento IG408M, ayudas IA360](https://sede.xunta.gal/detalle-procedemento?codtram=IG408M)

## 3. Kit Digital, cuando la IA forma parte de una solución del catálogo

**Veredicto:** Kit Digital puede encajar cuando necesitas una solución de digitalización incluida en el catálogo y esa solución incorpora IA. No lo plantees como una subvención automática para desarrollar un sistema propio desde cero.

**Mejor para:** una pyme o un autónomo que busca implantar una solución estandarizada de gestión de procesos, gestión de clientes, analítica o una categoría similar del programa, siempre que el segmento de empresa y la convocatoria aplicable lo permitan.
...
**Veredicto:** Kit Consulting tiene sentido en una fase anterior: cuando necesitas asesoramiento para identificar oportunidades, ordenar los datos y definir casos de uso antes de construir o implantar una solución.
...
**Veredicto:** si tu proyecto combina IA con innovación de producto, datos, industria o transformación digital, no te quedes solo con las convocatorias que llevan “IA” en el título. Puede existir una línea más adecuada para el tipo de gasto que quieres justificar.

**Mejor para:** proyectos que no son una simple licencia: integración con sistemas internos, tratamiento de datos empresariales, desarrollo de un producto nuevo o mejora de un proceso industrial.

**Cómo buscar sin perder semanas:**

1. Describe el problema y el resultado medible, no la tecnología que te gustaría comprar.
2. Separa las partidas: asesoramiento, desarrollo, licencias, infraestructura, formación y mantenimiento.
3. Comprueba si el proyecto debe empezar después de la solicitud.
4. Identifica el organismo gestor y lee la convocatoria completa.
5. Revisa compatibilidad, régimen de minimis, obligaciones de justificación y mantenimiento.
6. Pregunta qué parte queda fuera: IVA, consumo de modelos, soporte recurrente o cambios de alcance.

**Límite:** una búsqueda general no sustituye la lectura de las bases. La convocatoria adecuada depende del sector, tamaño, ubicación del centro de trabajo, naturaleza del gasto y calendario.

## Qué ayuda elegir según tu punto de partida
...
- Confundir una solución del catálogo con un desarrollo a medida.
- Empezar a trabajar o firmar un acuerdo irrevocable antes de comprobar la regla de inicio.
- Elegir una convocatoria por el nombre y no por los gastos elegibles.
- Presentar una memoria que describe IA, pero no el proceso que mejora ni cómo se medirá.
...
Una memoria útil responde a seis preguntas concretas:

1. ¿Qué problema operativo existe hoy?
2. ¿Qué proceso cambia y qué parte seguirá revisando una persona?
3. ¿Qué datos se usarán y dónde se alojarán?
4. ¿Qué entregable se construye o implanta?
5. ¿Qué indicador mejorará y cuál es la situación de partida?
6. ¿Qué calendario, presupuesto y riesgos tiene el proyecto?

En proyectos de IA conviene añadir cómo se tratarán los errores. Una automatización que no encuentra un dato, detecta una referencia dudosa o recibe un documento inesperado debe pedir revisión, no inventar una respuesta.

## El papel de una consultora

Una consultora puede ayudarte a identificar la convocatoria, convertir el proceso en un proyecto elegible, preparar la memoria técnica y diseñar la implantación. No puede garantizar que una ayuda se conceda ni convertir un gasto no elegible en elegible.

OSIX Tech trabaja en proyectos de automatización e IA para pymes y ofrece una consulta inicial para estudiar el encaje. Si el proyecto requiere una convocatoria, la decisión debe partir siempre de las bases oficiales y del organismo gestor.
...
La ficha oficial del procedimiento IG408M consultada el 30 de agosto de 2026 indica que la convocatoria 2026/2027 está cerrada y que el plazo fue del 17 de enero al 17 de marzo de 2026. Comprueba la ficha antes de preparar una solicitud futura.
...
No lo des por hecho. Algunas convocatorias exigen que el proyecto no haya empezado y que no exista un acuerdo irrevocable antes de la solicitud. Lee las bases concretas y confirma la regla con el organismo gestor.

## Nuestro límite honesto

OSIX Tech publica esta comparativa y aparece en ella como posible consultora, por lo que existe una relación comercial. No somos el organismo que concede las ayudas y no prometemos aprobación. Las convocatorias, fechas, importes y requisitos pueden cambiar. Antes de contratar o iniciar un gasto, verifica la ficha oficial y las bases vigentes.
