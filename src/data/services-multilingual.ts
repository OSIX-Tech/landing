...
export const servicesData: Record<string, Record<string, ServiceData>> = {
  es: {
    ...
    'consultoria-transformacion': {
      ...
      problemTitle: 'No sabes por dónde empezar con la IA',
      problem: 'Sabes que tu empresa podría funcionar mejor con tecnología e inteligencia artificial, pero no sabes por dónde empezar ni en quién confiar.',
      solutionTitle: 'Te guiamos paso a paso',
      solution: 'Visitamos tu empresa, entendemos cómo trabajáis de verdad y en menos de una semana te entregamos un plan de acción concreto con oportunidades de IA y estimación de ahorro.',
  ...
  en: {
    ...
    'consultoria-transformacion': {
      ...
      tagline: 'We tell you what can be improved with technology and AI',
      description: 'We visit your company, understand how you actually work, and honestly tell you what can be improved with technology and artificial intelligence. In less than a week you receive a report with concrete AI automation opportunities, savings estimates, and a prioritized action plan. If you don\'t need anything, we\'ll tell you. No strings attached.',
      icon: 'RefreshCw',
      highlights: [
      ...
      problemTitle: 'You don\'t know where to start with AI',
      problem: 'You know your company could work better with technology and artificial intelligence, but you don\'t know where to start or who to trust.',
      solutionTitle: 'We guide you step by step',
      solution: 'We visit your company, understand how you actually work, and in less than a week deliver a concrete action plan with AI opportunities and savings estimates.',
  ...
  gl: {
    ...
    'consultoria-transformacion': {
      id: 'consultoria-transformacion',
      title: 'Consultoría de Transformación Dixital e IA',
      tagline: 'Dicímosche que se pode mellorar con tecnoloxía e intelixencia artificial',
      description: 'Visitamos a túa empresa, entendemos como traballades de verdade e dicímosvos con honestidade que se pode mellorar con tecnoloxía e intelixencia artificial. En menos dunha semana recibes un informe con oportunidades concretas de automatización con IA, estimación de aforro e un plan de acción priorizado. Se non necesitas nada, dicímoscho. Sen compromiso, sen fume.',
      icon: 'RefreshCw',
      highlights: [
      ...
      problemTitle: 'Non sabes por onde empezar coa IA',
      problem: 'Sabes que a túa empresa podería funcionar mellor con tecnoloxía e intelixencia artificial, pero non sabes por onde empezar nin en quen confiar.',
      solutionTitle: 'Guiámoste paso a paso',
      solution: 'Visitamos a túa empresa, entendemos como traballades de verdade e en menos dunha semana entregámosche un plan de acción concreto con oportunidades de IA e estimación de aforro.',
